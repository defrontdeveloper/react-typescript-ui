...
import { AppbarStyled, AppbarContainerStyled, BodyContainerStyled, CardStyled } from './HomeStyle';
    ...
    <div>
      <AppbarStyled>
        <AppbarContainerStyled>
          <Typography variant="h6">TS - REACT - REDUX TOOLKIT - MATERIAL UI</Typography>
